...
class ImageChunker:
    ...
    def check_pad_length(self,pad_length) -> int:
    ...
    def check_number_of_chunks(self, number_of_chunks) -> int:
    ...
    def make_image_to_chunks(self) -> dict[str, np.ndarray]:
        ...
        for chunk_number in range(self.number_of_chunks):
            ...
            if chunk_number == number_of_chunks - 1 and self.image.shape[direction] % 2 != 0:
                chunk_shape[direction] = (
